<%-- 
    ...
    Created on : 21 may. 2020, 10:12:12
    Author     : charl
--%>
...
<html lang="en">
    ...
    <body onload="setMedicalHistoryEdit()">
                    ...
                    <div class="row">
                        <div class="col-xl-12 d-flex">
                            <div class="card flex-fill">
                                ...
                                <div class="card-body">
                                    <form onsubmit="updateMedicalHistory();
                                            return false">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" id="p_birth">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label">Place of residence</label>
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" id="p_residence">
                                            </div>
                                        </div>
                                        <div class="form-group row">
