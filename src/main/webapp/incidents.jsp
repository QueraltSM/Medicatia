                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                           ...
                           <li id="administrators_menu_section">
                            ...
                            <li id="doctors_menu_section">
                                <a href="incidents.jsp"><i class="fe fe-comment"></i> <span>Incidents</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12 d-flex">
                            <div class="card flex-fill">
                                ...
                                <div class="card-body">
                                    <label class="col-lg-3 col-form-label">Incidence:</label>
                                    <div class="form-group row">
                                        
                                        <div class="col-lg-9">
                                            <textarea class="form-control" rows="6" id="incidence"></textarea>
                                            <div id="errorMessage" class="error_label"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <input type="button" class="btn btn-primary" value="Send" onclick="saveIncidence()">
                                    </div>
                                </div>
                            </div>
                        </div>
